...
namespace ChartAndGraph
{
    ...
    public class RadarChartData : AbstractChartData, IInternalRadarData, IChartData
    {
        ...
        [SerializeField] private string[] mGroups = new string[0];

        [SerializeField] private DataEntry[] mData = new DataEntry[0];

        /// <summary>
        ///     set this to true to automatically detect the highest radar value int the chart. This value will be used to scale
        ///     all other radar entries
        /// </summary>
        [SerializeField] private bool automaticMaxValue = true;


        /// <summary>
        ///     Mannualy set the maximum value , all radar entires will be scaled based on this value. If a radar entry value is
        ///     larger than this value it will be clamped
        ///     Note: set AutomaticMaxValue to false in order to use this field
        /// </summary>
        [SerializeField] private double maxValue = 10;


        /// <summary>
        ///     set this to true to automatically detect the lowest radar value int the chart. This value will be used to scale all
        ///     other radar entries
        /// </summary>
        [SerializeField] private bool automaticMinValue;

        /// <summary>
        ///     Mannualy set the minimum value , all radar entires will be scaled based on this value. If a radar entry value is
        ///     larger than this value it will be clamped
        ///     Note: set AutomaticMinValue to false in order to use this field
        /// </summary>
        [SerializeField] private double minValue;

        private ChartSparseDataSource mDataSource = new();
        ...
        /// </summary>
        public int TotalGroups => mDataSource.Rows.Count;
        ...
        public void OnBeforeSerialize()
        {
            ...
            {
                var data = mDataSource.Columns[i].UserData as CategoryData;
        ...
        ChartSparseDataSource IInternalRadarData.InternalDataSource => mDataSource;

        public double GetMinValue()
        {
            var min = MinValue;
            var rawMin = mDataSource.getRawMinValue();
        ...
        {
            var max = MaxValue;
            var rawMax = mDataSource.getRawMaxValue();
        ...
        {
            var groups = mDataSource.Rows.Select(x => x.Name).ToArray();
            foreach (var s in groups) RemoveGroup(s);
        }
        ...
        ///     Example: you can set the chart categories to be "Player 1","Player 2","Player 3" in order to compare player
        ///     achivments
        public void AddCategory(string name, PathGenerator linePrefab, Material lineMaterial, float lineThickness,
            GameObject pointPrefab, Material pointMaterial, float pointSize, Material fillMaterial)
        {
            AddInnerCategory(name, null, lineMaterial, lineThickness, null, pointMaterial, pointSize, fillMaterial, 5,
                0f, 0f);
        }
        ...
        ///     achivments
        /// </summary>
        protected void AddInnerCategory(string name, PathGenerator linePrefab, Material lineMaterial,
            float lineThickness, GameObject pointPrefab, Material pointMaterial, float pointSize, Material fillMaterial,
            int fillSmoothing, float curve, float seperation)
        {
            var column = new ChartDataColumn(name);
        ...
        public void SetCategoryHover(string category, ChartItemEffect lineHover, ChartItemEffect pointHover)
        {
            try
            {
                var data = mDataSource.Columns[category].UserData as CategoryData;
                if (data == null)
        ...
        protected void SetInnerCategoryLine(string category, PathGenerator linePrefab, Material lineMaterial,
            float lineThickness)
        {
            try
            {
        ...
        protected void SetInnerCategoryPoint(string category, GameObject prefab, Material pointMaterial,
            float pointSize)
        {
            try
            {
        ...
        ///     Example: you can set the categories to "Player 1","Player 2","Player 3" and the groups to
        ///     "Gold","Wood","Oil","Total"
        ...
        internal class CategoryData
        {
            ...
            [HideInInspector] public double MaxValue = -1f;
