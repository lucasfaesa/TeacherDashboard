...
{
    /// <summary>
    ///     this inteface hides some functionallity so it is not public with scrollableAxisData. This funcationallity is meant
    ///     to be used internally by the mixedSeriesChart
    /// </summary>
    internal interface IMixedSeriesProxy
    {
        /// <summary>
        ...
        /// <summary>
        ///     this method allows The MixesSeriesChart to append a series of datum objects to the specified category in a generic
        ///     way
        /// </summary>
        /// <param name="category"></param>
        /// <param name="value"></param>
